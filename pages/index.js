        ...
        >
            ...
            >
                ...
                >
                    ...
                    <Flex flexDir="column" alignItems="center" mb={10} mt={5}>
                        ...
                        <Text textAlign="center">David Nolan</Text>
                    </Flex>
                </Flex>
            </Flex>
            ...
            >
                <Heading
                    ...
                    letterSpacing="tight"
                >
                    Welcome back, <Flex display="inline-flex" fontWeight="bold">David</Flex>
                </Heading>
                                ...
                                {display == 'show' &&
                                    <>
                                        <Tr>
                                            <Td>
                                                <Flex align="center">
                                                    <Avatar size="sm" mr={2} src="migros.png" />
                                                    <Flex flexDir="column">
                                                        <Heading size="sm" letterSpacing="tight">Migros</Heading>
                                        ...
                                        <Tr>
                                            <Td>
                                                <Flex align="center">
                                                    <Avatar size="sm" mr={2} src="levis.png" />
                                                    <Flex flexDir="column">
                                                        <Heading size="sm" letterSpacing="tight">Levi's</Heading>
                                        ...
                                        <Tr>
                                            <Td>
                                                <Flex align="center">
                                                    <Avatar size="sm" mr={2} src="McDonalds.png" />
                                                    <Flex flexDir="column">
                                                        <Heading size="sm" letterSpacing="tight">McDonalds</Heading>
            ...
            >
                            ...
                            <Flex align="flex-end" justify="space-between">
                                <Flex>
                                    <Flex flexDir="column" mr={4}>
                                        <Text textTransform="uppercase" fontSize="xs">Valid Date</Text>
                ...
                <Flex justifyContent="center" mt={2}>
                    <Button borderRadius={50} bgColor={value == 1 ? "gray.600" : "gray.400"} size="xs" mx={1} onClick={() => changeValue(1)} />
                    <Button borderRadius={50} bgColor={value == 2 ? "gray.600" : "gray.400"} size="xs" mx={1} onClick={() => changeValue(2)} />
                    <Button borderRadius={50} bgColor={value == 3 ? "gray.600" : "gray.400"} size="xs" mx={1} onClick={() => changeValue(3)} />
                </Flex>
                ...
                <InputGroup>
                    ...
                    />
                    <Input type="text" placeholder="XXXX XXXX XXXX XXXX" value={ccNumber} onChange={formatAndSetCcNumber} />
                </InputGroup>
                ...
                <Button mt={4} bgColor="blackAlpha.900" color="#fff" p={7} borderRadius={15} _hover={{ bg: "whitesmoke" , color: '#000', border: "1px solid #000" }}>Send money</Button>
            </Flex>
        </Flex>
    )
}
